class TodayDealDetailsModel {
  int? status;
  dynamic count;
  TodayDetailsData? todayDetailsData;

  TodayDealDetailsModel({this.status, this.count, this.todayDetailsData});

  TodayDealDetailsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    count = json['count'];
    todayDetailsData = json['data'] != null ? TodayDetailsData.fromJson(json['data']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['status'] = status;
    data['count'] = count;
    if (todayDetailsData != null) {
      data['data'] = todayDetailsData!.toJson();
    }
    return data;
  }
}

class TodayDetailsData {
  int? currentPage;
  List<Data>? data;
  String? firstPageUrl;
  int? from;
  ...
  TodayDetailsData.fromJson(Map<String, dynamic> json) {
